...
model=pkl.load(open("Heart_SVM.p","rb"))
...
trestbps = st.slider('Resting Blood Sugar', 100, 500, (180), step=1)
restecg=st.selectbox('Resting Electrocardiographic Results',("Nothing to note","ST-T Wave abnormality","Possible or definite left ventricular hypertrophy"))

chol = st.slider('Serum Cholestoral in mg/dl', 100, 1000, (190), step=1)
fbs=st.radio("Fasting Blood Sugar higher than 120 mg/dl", ['Yes','No'])

thalach = st.slider('Maximum Heart Rate Achieved', 50, 300, (120), step=1)
...
if st.button("Predict"):    
  if pred[0] == 0:
    st.success('Yay!!! You have lower risk of getting a heart disease!') 
  else:
...
st.sidebar.info("This web app is to help you to find out if you are at a risk of developing a heart disease.")
st.sidebar.info("Fill the required forms and click on the 'Predict' button to check whether you have a healthy heart or not")
st.sidebar.info("Remember! That app is not created by the doctor but if prediction concerns you, maybe you should visit one.")
